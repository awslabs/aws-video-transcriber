    ...
    try
    {
        ...
        if (getResponse.Item)
        {
            ...
            if (video.s3VideoPath) {
                console.log('[INFO] Start to delete input video : %s', video.s3VideoPath);
            ...
            if (video.s3TranscodedVideoPath) {
                console.log('[INFO] Start to delete transcoded video: %s', video.s3TranscodedVideoPath);
            ...
            if (video.s3BurnedVideoPath) {
                console.log('[INFO] Start to delete burned video: %s', video.s3BurnedVideoPath);

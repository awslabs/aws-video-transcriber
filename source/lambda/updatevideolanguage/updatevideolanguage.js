...
exports.handler = async (event, context, callback) => {
    ...
    try
    {
        ...
        console.log("[INFO] update dynamoDB and videoId is %s and language is %s", jobName, language);
    ...
    catch (error)
    {
        ...
        const response = {
            statusCode: 500,
            headers: responseHeaders,
            body: JSON.stringify({  "message": "Failed to update video language: " + error.message })
        };
        callback(null, response);
    }
};

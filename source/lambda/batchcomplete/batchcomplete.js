...
exports.handler = async (event, context, callback) => {
    ...
    try
    {
        ...
        if (getVideoResponse.Item)
        {
            ...
            await generateCaptions(videoId, video.translatedLanguage, translated, destBucket, destKeyPrefix, videoName);
...
async function generateCaptions(videoId, language, translated, destBucket, destKeyPrefix, videoName)
{
...
async function moveBurnedVedio(destBucket, destKeyPrefix, destFileName, sourceS3Path)
{

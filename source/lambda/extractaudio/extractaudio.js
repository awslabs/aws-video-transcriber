...
function computeRemainingParams(event, params)
{
    ...
    params.outputAudioS3Path = "s3://" + outputAudioBucket + "/" + outputAudioKeyPrefix + "/" + params.videoNamePrefix + "_" + params.videoId + ".mp4";
        ...
        "Settings": {
            ...
            "OutputGroups": [
            {
                ...
                "OutputGroupSettings": {
                    ...
                    "FileGroupSettings": {
                        "Destination": "s3://" + params.outputAudioBucket + "/" + params.outputAudioKeyPrefix + "/"
                    }
                }                
            }
            ],
